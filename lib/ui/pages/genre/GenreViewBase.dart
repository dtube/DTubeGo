...
class GenreViewBase extends StatefulWidget {
  String feedType;
  ...
  @override
  State<GenreViewBase> createState() => _GenreViewBaseState();
}

class _GenreViewBaseState extends State<GenreViewBase>
    with AutomaticKeepAliveClientMixin<GenreViewBase> {
  String? postAuthor;
  String? postLink;
